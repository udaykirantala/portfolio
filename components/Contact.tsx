...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "udaykirantala@gmail.com",
    href: "udaykirantala@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+91 9502596828",
    href: "tel:+91 9502596282",
  },
  {
    icon: MapPin,
    label: "Location",
...
const socialLinks = [
  {
    icon: Github,
    label: "GitHub",
    href: "https://github.com/udaykirantala",
  },
  {
    icon: Linkedin,
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/udaykiran-tala-8402b7349?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_apphttps://www.linkedin.com/in/udaykiran-tala-8402b7349?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
  },
];
