...
const aboutData = {
  intro: "I'm a passionate Front-End Developer eager to build intuitive and responsive web interfaces. As a fresher, I bring strong foundational knowledge of HTML, CSS, JavaScript, and modern front-end frameworks. I'm driven by a desire to create seamless user experiences through clean design, performance optimization, and continuous learning.",
  attributes: [
  ...
  goals: [
    ...
    "To collaborate with design and development teams to build high-quality, scalable web applications.",
    "To continuously enhance my front-end development skills by working with modern technologies like React, Vue, or Angular"
  ]
};
